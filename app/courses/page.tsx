...
const courses = [
  // 基础课程 (Beginner)
  {
    id: 1,
    name: 'Linear Algebra',
    description: 'Master the fundamentals of linear algebra essential for machine learning and data science. This foundational course is a prerequisite for advanced ML courses.',
    level: 'Beginner',
    duration: '8 weeks',
